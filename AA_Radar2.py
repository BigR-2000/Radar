...
whitelist_credentials = {
    ...
    'kristof.de.croock@kaagent.be': 'KaaGent_9000'
}
...
if user_email in whitelist_credentials:
    if user_password == whitelist_credentials[user_email]:
        ...
        def radarcharts():
            ...
            list_centralmidfield = ['S. Kums', 'J. De_Sart', 'O. Gandelman', 'P. Gerkens', 'R. Onyedika', 'C. Nielsen', 'H. Vetlesen', 'P. Hrošovský', 'B. Heynen', 'M. Galarza', 'L. Lopes', 'H. Van_der_Bruggen', 'A. Vermeeren', 'M. Keita', 'A. Yusuf', 'T. Leoni', 'M. Rits', 'N. Sadiki', 'M. Rasmussen', 'C. Vanhoutte', 'L. Amani', 'A. Kadri',  'O. Højlund', 'P. Berg', 'P. Aaronson', 'O. Sørensen', 'T. Rigo', 'A. Bernede', 'L. Bate', 'A. Omgba', 'B. Krushynskyi', 'D. Moses', 'J. McGlynn'] #,'S. Esposito',  'A. Omgba_8','J. Pršir', 'N. Souren', 'A. Omgba_10', 'M. Kusu','F. Krastev', 'F. Krastev_total', 'C. Rodri', 'A. Bernede', 'L. Bate', 'F. Krastev', 'F. Krastev_total''C. Rodri', , 'S. Resink','S. Esposito', 'J. Bakke', 'R. Pukštas', 'A. Morris',  'G. Busio',
            list_attackingmidfield = ['H. Hong', 'A. Hjulsager', 'B. El_Khannouss', 'H. Vanaken', 'J. Ekkelenkamp', 'C. Puertas', 'A. Omgba', 'A. Karabec', 'G. Fujimoto']
